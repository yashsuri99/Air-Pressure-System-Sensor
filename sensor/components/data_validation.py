...
class DataValidation:
    ...
    def validate_number_of_columns(self,dataframe:pd.DataFrame)->bool:
        try:
            ...
            logging.info("Required number of columns: {}".format(number_of_columns))
            logging.info("Data frame has columns: {}".format(len(dataframe.columns)))
    ...
    def is_numerical_column_exist(self,dataframe:pd.DataFrame)->bool:
        try:
            ...
            logging.info("Missing numerical columns: [{}]".format(missing_numerical_columns))
    ...
    def initiate_data_validation(self)->DataValidationArtifact:
        try:
            ...
            logging.info("Data validation artifact: {}".format(data_validation_artifact))
